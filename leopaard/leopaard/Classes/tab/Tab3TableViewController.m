...
#import "Tab3TableViewController.h"

@interface Tab3TableViewController ()

@end

@implementation Tab3TableViewController
...
//    _currentData = [rootDic objectForKey:@"rows"];
    ...
    _currentData = [de getItemDicWithTabType:ITEM_TYPE_PEIXUN];
}
